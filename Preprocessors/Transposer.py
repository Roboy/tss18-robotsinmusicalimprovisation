...
if __name__ == '__main__':
    ...
    parser.add_argument("--tp_by", help='Set the value how much you want to transpose your MIDI files. Max: 59, Default: 59', type=int)
    ...
    if args.tp_by:
        ...
        print("Chose default for transpositions, will transpose by 59 semitones.")
        tp_by = 59
    ...
    for count, f in enumerate(files_list):
        try:
            ...
            skipped += 1
            print("Had to skip a file for some reason.")

        print("{}/{}".format(count+1,len(files_list)))

    print("Done!! Had to skip {} MIDI files though.".format(skipped))